...
@Composable
fun HitungContent(modifier: Modifier) {
...
@Composable
fun HitungScreen(navController: NavController) {
    Scaffold (
        topBar = {
            TopAppBar(
                navigationIcon = {
                ...
                title = {
                    Text(text = stringResource(id = R.string.hitung_app))
                },
        ...
        HitungContent(Modifier.padding(padding))
    }
}
...
fun HitungPreview() {
    MiniprojectTheme {
        HitungScreen(rememberNavController())
    }
}